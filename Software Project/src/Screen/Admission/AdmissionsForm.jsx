...
import styles from "./AdmissionsForm.module.css";
import { database } from "../../config/firebase";
import { addDoc, collection, getDocs } from "firebase/firestore";

const AdmissionRegisForm = () => {
  ...
  const addData = async () => {
    try {
      ...
      navigate("/Dashboard/Admission/AdmissionList");
    } catch (error) {
  ...
  const getData = async () => {
    try {
      ...
      const getData = await getDocs(
        collection(database, "Admission Form Data")
      );
...
export default AdmissionRegisForm;
